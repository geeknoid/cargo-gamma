        ...
        .filter_map(|(path, mutants)| {
            ...
            let mut mutants: Vec<MutantResult> = mutants
                ...
                .filter_map(|verdict| {
                    ...
                    let mut mutant = verdict.mutant.clone();

                    mutant.mutator_name.clone_from(&presentation.mutator_name);
                    mutant.location = presentation.location;
                    mutant.replacement.clone_from(&presentation.replacement);
                    mutant.description.clone_from(&presentation.description);
