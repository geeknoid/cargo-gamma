...
//!
//! Read by incremental execution (`--incremental full`), which carries settled kills forward without re-running them. A
//! kill is a claim about the suite, not about the code: the mutant's identity hashes the file, the
